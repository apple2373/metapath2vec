...
def build_model(BATCH_SIZE,VOCAB_SIZE,EMBED_SIZE,NUM_SAMPLED,negative_sampler=None):
    '''
    ...
    return center_node,context_node,loss
...
def train(center_node_placeholder,context_node_placeholder,loss,dataset,optimizer,NUM_EPOCHS,BATCH_SIZE,LOG_DIRECTORY,LOG_INTERVAL,MAX_KEEP_MODEL):
    '''
